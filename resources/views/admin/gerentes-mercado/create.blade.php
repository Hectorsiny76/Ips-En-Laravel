    ...
    <div class="flex-1 overflow-auto bg-white shadow rounded-lg p-3">
        <form action="{{route('admin.estados.gerentes-mercado.store', $estado->id)}}" method="POST">
            ...
            <div class="flex justify-center space-x-3 mt-8 pt-4 border-t border-gray-500">
                <a href="{{route('admin.estados.gerentes-mercado.index', $estado->id)}}" class="px-6 py-2 text-lg font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancelar
                </a>
                <button
                    type="submit"
