...
@section('content')
    ...
    <div class="flex-1 overflow-auto bg-white shadow rounded-lg p-3">
        ...
        @endif
        <form action="{{route('gerentes-mercado.mercados.store', $mercadoGerente->id)}}" method="POST">
            @csrf
            <div class="mb-6">
            ...
            <div class="flex justify-center space-x-3 mt-8 pt-4 border-t border-gray-500">
                <a href="{{route('estados.gerentes-mercado.index', $mercadoGerente->estado->id)}}" class="px-6 py-2 text-lg font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancelar
                </a>
                <button
                    type="submit"
